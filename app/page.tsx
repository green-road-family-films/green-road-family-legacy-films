...
export default function Home(){
 ...
 return <main>
  ...
  <ArchitectureSection title="INTRODUCTION FILM" dark/>
  ...
  <footer><div className="footer-brand"><span>GREEN ROAD</span><small>FAMILY LEGACY FILMS</small></div><div className="footer-links"><a href="#stories">Stories</a><a href="#films">The Films</a><a href="#experience">The Experience</a><a href="#about">About</a><a href="#faq">FAQ</a><a href="#inquire">Inquire</a></div><div className="footer-contact"><a href="mailto:hello@greenroadfilms.com">hello@greenroadfilms.com</a><a href="tel:+14158161060">+1 415 816 1060</a><span>San Francisco Bay Area, California</span></div><div className="footer-meta"><span>© 2026 Green Road Films, LLC</span><span>Privacy · Legal · Terms</span></div></footer>
 </main>
}
