...
export default function Home(){
 ...
 return <main>
  ...
  <footer><div className="footer-brand"><span>GREEN ROAD</span><small>FAMILY LEGACY FILMS</small></div><p>Your Story. Their Legacy.<br/>A Film for Generations.</p><div className="footer-links"><a href="#stories">Stories</a><a href="#films">The Films</a><a href="#experience">The Experience</a><a href="#about">About</a><a href="#faq">FAQ</a><a href="#inquire">Inquire</a></div><div className="footer-meta"><span>San Francisco · Sacramento · Northern California</span><span>© 2026 Green Road Films, LLC</span><span>Demo photography: Mikhail Nilov, SHVETS production, Антон Жук, Caique Araujo &amp; Ron Lach / Pexels</span></div></footer>
 </main>
}
